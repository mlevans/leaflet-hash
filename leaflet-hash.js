...
StatefulHash = (function() {

  function StatefulHash(map) {
    var parsed,
      _this = this;
    this.map = map;
  ...
  StatefulHash.prototype.parseHash = function(hash) {
  ...
  StatefulHash.prototype.formatHash = function() {
  ...
  StatefulHash.prototype.remove = function() {
